import{j as e}from"../vendor/react-CJ2V4BqM.js";import{m as t}from"../vendor/framer-motion-CLzqDuJ2.js";function s({stage:a,darkMode:n,lang:i}){return e.jsxs(t.div,{className:"fixed inset-0 bg-black/80 backdrop-blur-sm flex flex-col items-center justify-center z-50",initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{duration:.3},children:[e.jsxs("div",{className:"relative mb-8",children:[e.jsx("span",{className:"loader"}),e.jsx("style",{children:`
          .loader {
            position: relative;
            width: 108px;
